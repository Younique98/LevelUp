...
class GameTests(APITestCase):
    def setUp(self):
        ...
        """
        # this can be any api that is being used beyond register
        url = "/register"
        # data similar to our fixtures
        data = {
            "username": "steve",
            "password": "Admin8*",
        ...
        # Store the auth token, will be used through out other places in the application
        self.token = json_response["token"]

        # Assert that a user was created
        # its doing an if check response.statusuc-code === status.HTTP_201_created to see if it is false to throw an error
...
## test below writes code the gameView
    def test_create_game(self):
        ...
        # Make sure request is authenticated, similar to a fetch
        ...
        #this is reference to lines 52- 57 ie frontEnd
        ...
        ## **----- make sure this matches your game.py
